package com.daxiang.propertyanimationdemo.view;
...
public class StickyView extends View {
	...
	private void init() {
		...
		mCenterRadius = density * 20;
		mStartRadius = mCenterRadius;

		mPath = new Path();
		mPaint = new Paint();
		mPaint.setColor(Color.parseColor("#B51313"));
	...
	private void initAnim() {
		animator = ValueAnimator.ofFloat(1f, 0f).setDuration(200);
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:
			if (x < mCenterX - mCenterRadius || x > mCenterX + mCenterRadius || y < mCenterY - mCenterRadius
					|| y > mCenterY + mCenterRadius) {
				return false;
			}
